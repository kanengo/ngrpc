...
func TestDirect(t *testing.T) {
	...
	//if time.Millisecond*15 <= wn.PickLastTime() {
	//	t.Errorf("time.Millisecond*15 <= wn.PickElapsed()(%v)", wn.PickLastTime())
	//}
	//if time.Millisecond*5 >= wn.PickLastTime() {
	//	t.Errorf("time.Millisecond*5 >= wn.PickElapsed()(%v)", wn.PickLastTime())
	//}
}
